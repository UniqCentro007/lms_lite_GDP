...
if DB_HOST and DB_HOST != 'localhost':
    ...
    # Fallback to SQLite for quick setup
    DATABASES = {
        'default': {
...
AWS_STORAGE_BUCKET_NAME = config('AWS_STORAGE_BUCKET_NAME', default='lms-media-bucket')
...
CERTIFICATE_MIN_SCORE = config('CERTIFICATE_MIN_SCORE', default=70, cast=int)
CERTIFICATE_REQUIRE_APPROVAL = config('CERTIFICATE_REQUIRE_APPROVAL', default=False, cast=bool)
